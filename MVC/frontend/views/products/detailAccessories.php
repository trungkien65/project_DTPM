...
<section class="contact ">
    <div class="container-fluid home-detail">
        <div class="row">
            <div class="side-bar left-ads-display col-lg-12 rounded content-cat">
                <div>
                    <div class="header-cat"><h4>Máy sục khí bể cá</h4></div>
                    <div>
                    ...
                    <div class="header-cat"><h4>Đèn bể cá cảnh</h4></div>
                    <div>
                        <?php if (!empty($products)): ?>
                            <div class="row">
                                <?php foreach ($products AS $product):
